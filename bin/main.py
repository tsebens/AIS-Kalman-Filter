...
in_table_vessel = TableVessel(conn, in_table, id_field=Field("VESSEL_ID"), id_value=2791)
out_table_vessel = TableVessel(conn, out_table, id_field=Field("VESSEL_ID"), id_value=2791)
